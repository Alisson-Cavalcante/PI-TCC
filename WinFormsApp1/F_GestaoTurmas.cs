...
namespace WinFormsApp1
{
    public partial class F_GestaoTurmas : Form
    {
        ...
        int modo = 0;//Nem edição e nem inserção 1 = edição 2=inserção 0 = padrão
        string vqueryDGV;
        ...
        private void cm_status_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            vqueryDGV = "SELECT tbt.N_IDTURMA AS 'ID', tbt.T_DSCTURMA AS 'Turma', tbh.T_DSCHORARIO as 'Horário' FROM tb_turmas as tbt INNER JOIN tb_horarios as tbh on tbh.N_IDHORARIO = tbt.N_IDHORARIO";
        ...
        private void dgv_turmas_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (contLinhas > 0)
            {
                ...
                string vqueryCampos = "SELECT T_DSCTURMA, N_IDPROFESSOR, N_MAXALUNOS, N_IDHORARIO, N_MAXALUNOS, T_STATUS FROM tb_turmas WHERE N_IDTURMA=" + idSelecionado;
        ...
        private void tb_dscTurma_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (modo == 0)
            {
                modo = 1;
        ...
        private void n_maxAlunos_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (modo == 0)
            {
                modo = 1;
        ...
        {
            String momearquivo = Globais.caminho + @"\turmas.pdf";
            ...
            paragrafo2.Add("Projeto Interdisciplinar\n\n");
            ...
            //DialogResult res = MessageBox.Show("Deseja abrir o Relatório?","Abrir", MessageBoxButtons.YesNo);
            //if(res == DialogResult.Yes)
            //{
