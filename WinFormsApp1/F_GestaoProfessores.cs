...
namespace WinFormsApp1
{
    public partial class F_GestaoProfessores : Form
    {
        ...
        {
            string vquery = "SELECT N_IDPROFESSOR as 'ID', T_NOMEPROFESSOR as 'Nome', T_TELEFONE as 'Telefone' FROM tb_professores ORDER BY N_IDPROFESSOR";
        ...
        private void btn_salvar_Click(object sender, EventArgs e)
        {
            ...
            vquery = @"SELECT N_IDPROFESSOR as 'ID', T_NOMEPROFESSOR as 'Nome', T_TELEFONE as 'Telefone' FROM tb_professores ORDER BY N_IDPROFESSOR";
            dgv_professores.DataSource = Banco.dql(vquery);
        }
